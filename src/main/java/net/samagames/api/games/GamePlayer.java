...
public class GamePlayer
{
    ...
    public void handleLogin(boolean reconnect)
    {
        ...
        BossBarAPI.setBar(this.getPlayerIfOnline(), ChatColor.YELLOW + "Vous jouez sur " + ChatColor.GOLD + "mc.samagames.net" + ChatColor.YELLOW + "!", BarColor.YELLOW, BarStyle.SOLID, 100.0D);
    }
