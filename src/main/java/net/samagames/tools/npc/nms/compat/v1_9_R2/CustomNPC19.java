 ...
 */
public class CustomNPC19 extends EntityPlayer implements ICustomNPC
{
    private NPCInteractCallback callback;

    private Hologram hologram;

    public CustomNPC19(World world, GameProfile gameprofile, PlayerInteractManager playerInteractManager)
    {
        ...
        this.playerConnection = new VoidPlayerConnection19(world.getServer().getServer(), this);
        this.getDataWatcher().set(br, Byte.MAX_VALUE);
    }

    public CustomNPC19(Object world, GameProfile gameprofile)
    {
    ...
    public CustomNPC19 setCallback(NPCInteractCallback callback)
    {
