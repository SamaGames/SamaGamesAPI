...
import net.samagames.tools.bossbar.nms.FakeDragon;
import net.samagames.tools.bossbar.nms.v1_8Fake;
import net.samagames.tools.bossbar.nms.v1_9;
...
public class BarAPI implements Listener
{
    ...
    public BarAPI(SamaGamesAPI api)
    {
        ...
        api.getPlugin().getServer().getPluginManager().registerEvents(this, plugin);
